...
class OscarAnnotatorSpec extends AnnotatorBaseSpec {
  ...
  private[this] lazy val expectations = Table(
    ...
    (
      ...
      Set((Sentence("InChI=1/C3H8/c1-3-2/h3H2,1-2H3"), Compound, Size(1))),
      Set((Sentence("methylethane"), Position(0), Position(12)))
    ),
    (
      ("one-phrase document", "Then we mix benzene with napthyridine and toluene."),
      Set(
        (Sentence("InChI=1/C6H6/c1-2-4-6-5-3-1/h1-6H"),       Compound, Size(1)),
        (Sentence("InChI=1/C7H8/c1-7-5-3-2-4-6-7/h2-6H,1H3"), Compound, Size(1))
      ),
      Set(
